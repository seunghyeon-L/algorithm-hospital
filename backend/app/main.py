...
class GenerateInstanceRequest(BaseModel):
    ...
    n_staff: int = Field(default=14, ge=1, le=80, description="간호 동시가용 ≈14 (FOIA 표3 43명÷3교대)")
    n_anesthesia: int = Field(default=9, ge=1, le=40, description="마취 전문의 9 (FOIA 표3 2025)")
